...
@Component({
  selector: 'app-szimbolizmus',
  templateUrl: './szimbolizmus.component.html',
  styleUrls: ['./szimbolizmus.component.scss']
})
export class SzimbolizmusComponent {
  artList: Art[] =[
    {
      id: 1,
      name: 'Zoodiac',
    ...
    {
      id: 39,
      name: 'Portrait of a Man with a Medal of Cosimo the Elder',
      author: 'Sandro Botticelli',
      price: 499000000,
      available: true,
